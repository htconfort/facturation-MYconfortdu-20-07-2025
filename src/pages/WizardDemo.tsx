...
import {
  ProductsEditor,
  ProductForm,
} from '../components/editors/ProductsEditor';
      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='bg-white rounded-lg shadow-sm border p-6 mb-6'>
          ...
          <p className='text-gray-600'>
            Touchez les blocs ci-dessous pour les éditer en plein écran
            (optimisé iPad)
          </p>
        </div>
        ...
        <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 text-center'>
          ...
          <div className='text-blue-600 text-sm'>
            Sur iPad, les éditeurs s'ouvrent en plein écran pour une saisie
            confortable. Sur desktop, ils s'ouvrent en modal large.
          </div>
        </div>
      </div>
