      ...
      <div className='bg-[#477A0C] rounded-xl shadow-[0_10px_25px_-5px_rgba(0,0,0,0.3)] p-8 mb-8 border border-gray-100'>
        ...
        <div className='bg-[#F2EFE2] rounded-lg p-8'>
          ...
          <div className='bg-white rounded-2xl p-6 mb-6 shadow-lg border-2 border-gray-200'>
            <h3 className='text-lg font-semibold text-[#477A0C] mb-4'>
              ➕ Ajouter un produit
            </h3>
              ...
              <div className='col-span-2'>
                ...
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    step='0.01'
                    min='0'
                    className={`flex-1 h-16 rounded-xl border-2 px-4 text-xl transition-all ${
                      draft.discount > 0
                ...
                <div className='text-sm space-y-1'>
                  <div className='text-gray-600'>
                    ...
                    <strong className='text-gray-800'>
                      {calculateHT(draft.priceTTC, taxRate).toFixed(2)} €
                    </strong>
                  </div>
                  {draft.discount > 0 && (
                    <>
                      <div className='text-gray-600'>
                        ...
                        <span className='line-through'>
                          {(draft.qty * draft.priceTTC).toFixed(2)} €
                        </span>
                      </div>
              ...
              <table className='w-full text-left'>
                <thead className='bg-[#477A0C] text-white'>
                  <tr>
                    ...
                    <th className='px-3 py-2 text-center text-lg font-bold'>
                      Quantité
                    </th>
                    <th className='px-3 py-2 text-right text-lg font-bold'>
                      PU HT
                    </th>
                    <th className='px-3 py-2 text-right text-lg font-bold'>
                      PU TTC
                ...
                <tbody>
                  ...
                  {produits.length === 0 && (
                    <tr>
                      <td
                        className='px-6 py-12 text-gray-500 text-center text-lg'
                        colSpan={8}
                      >
                ...
                {produits.length > 0 && (
                  <tfoot className='bg-[#F2EFE2]'>
                    <tr>
                      <td
                        className='px-4 py-4 text-right font-bold text-lg text-[#477A0C]'
                        colSpan={4}
                      >
                        Total HT:
                      </td>
                    ...
                    <tr>
                      <td
                        className='px-4 py-2 text-right font-bold text-lg text-[#477A0C]'
                        colSpan={4}
                      >
                        TVA ({taxRate}%):
                      </td>
                    ...
                    {totals.totalRemise > 0 && (
                      <tr className='bg-pink-50 border-t-2 border-pink-200'>
                        <td
                          className='px-4 py-3 text-right font-bold text-lg text-pink-600'
                          colSpan={4}
                        >
