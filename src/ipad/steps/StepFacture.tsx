...
export default function StepFacture({ onNext, onQuit }: StepProps) {
  const { invoiceNumber, invoiceDate, eventLocation, setInvoiceData } = useInvoiceWizard();
  ...
  return (
    <div className="max-w-6xl mx-auto py-8">
        ...
        <div className="bg-[#F2EFE2] rounded-lg p-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-black font-semibold text-lg"><strong>88 Avenue des Ternes</strong></p>
              <p className="text-black font-semibold text-lg">75017 Paris, France</p>
              <p className="text-black font-semibold text-lg">SIRET: 824 313 530 00027</p>
              <p className="text-black font-semibold text-lg">Tél: 04 68 50 41 45</p>
              <p className="text-black font-semibold text-lg">Email: myconfort@gmail.com</p>
              <p className="text-black font-semibold text-lg">Site web: https://www.htconfort.com</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col space-y-2">
                <span className="font-bold text-black text-lg">Facture n°:</span>
                <input
                  value={invoiceNumber}
                  type="text"
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <ul className="text-blue-700 space-y-1">
              ...
              <li>• 🎯 <strong>Une seule chose à faire :</strong> Remplir le lieu d'événement</li>
              <li>• 🔴➡️🟢 Le cadre devient vert quand c'est rempli</li>
              <li>• 🚫 Impossible de continuer tant que le lieu n'est pas renseigné</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center">
        ...
        >
          {isLocationEmpty ? '🚫 Remplir le lieu d\'abord' : '✅ Suivant: Client →'}
        </button>
      </div>
    </div>
  );
