      ...
      <div className='space-y-6'>
        ...
        <div className='p-6 bg-white border-2 border-myconfort-green rounded-lg shadow-sm'>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex justify-between items-center'>
              ...
              <span className='font-medium text-myconfort-dark'>
                {dateFacture
                  ? new Date(dateFacture).toLocaleDateString('fr-FR')
                  : 'Non définie'}
              </span>
            </div>
          </div>
        ...
        <div className='p-4 bg-myconfort-blue bg-opacity-10 border border-myconfort-blue rounded-lg'>
          <p className='text-sm text-gray-700'>
            💡 <strong>Conseil:</strong> Le numéro de facture est généré
            automatiquement mais vous pouvez le modifier. Assurez-vous qu'il
            soit unique pour éviter les doublons.
          </p>
        </div>
      </div>
    </div>
