...
export default function StepClientNoScroll({ onNext, onPrev }: StepProps) {
  ...
  const updateField = (field: string, value: string) => updateClient({ [field]: value });
  ...
  const isFieldValid = (field: keyof typeof validity) => !hasAttemptedNext || validity[field];

  const allFieldsValid =
    validity.name && validity.email && validity.phone && validity.address &&
    validity.city && validity.postalCode && validity.housingType && validity.doorCode;
    ...
    <div className="min-h-screen w-full bg-myconfort-cream">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 pt-6 pb-6">
        ...
        <div className="px-4 py-2 border-b border-myconfort-dark/10 mb-4">
          <h1 className="text-3xl font-bold text-myconfort-dark font-manrope">👤 Informations Client</h1>
        ...
        <div className="px-4">
          <form className="grid grid-cols-1 gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-0">
                <label className="flex items-center gap-1 text-base font-medium text-myconfort-dark font-manrope">
                  <User className="w-4 h-4 text-myconfort-green" /> Nom complet <span className="text-red-600 font-bold">*</span>
                </label>
                <input
                  ref={nameRef}
                  type="text"
                  ...
                  required
                />
                {!isFieldValid('name') && <p className="text-myconfort-coral text-xs">Le nom doit faire plus de 2 caractères.</p>}
              </div>

              {/* Email */}
              <div className="space-y-0">
                <label className="flex items-center gap-1 text-base font-medium text-myconfort-dark font-manrope">
                  <Mail className="w-4 h-4 text-myconfort-green" /> Email <span className="text-red-600 font-bold">*</span>
                </label>
                <input
                  type="email"
                  value={client.email || ''}
                  ...
                  required
                />
                {!isFieldValid('email') && <p className="text-myconfort-coral text-xs">Adresse email valide requise.</p>}
              </div>

              {/* Téléphone */}
              <div className="space-y-0">
                <label className="flex items-center gap-1 text-base font-medium text-myconfort-dark font-manrope">
                  <Phone className="w-4 h-4 text-myconfort-green" /> Téléphone <span className="text-red-600 font-bold">*</span>
                </label>
                <input
                  type="tel"
                  value={client.phone || ''}
                  ...
                  required
                />
                {!isFieldValid('phone') && <p className="text-myconfort-coral text-xs">Numéro de téléphone requis.</p>}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-0">
                <label className="flex items-center gap-1 text-base font-medium text-myconfort-dark font-manrope">
                  <MapPin className="w-4 h-4 text-myconfort-green" /> Adresse <span className="text-red-600 font-bold">*</span>
                </label>
                <input
                  type="text"
                  ...
                  required
                />
                {!isFieldValid('address') && <p className="text-myconfort-coral text-xs">Ce champ est requis.</p>}
              </div>

              {/* Adresse 2 (optionnelle) */}
              <div className="space-y-0">
                <label className="flex items-center gap-1 text-base font-medium text-myconfort-dark font-manrope">
                  <Building className="w-4 h-4 text-gray-400" /> Adresse 2 (optionnel)
                </label>
                <input
                  type="text"
              ...
              <div className="space-y-0">
                <label className="flex items-center gap-1 text-base font-medium text-myconfort-dark font-manrope">
                  <Building className="w-4 h-4 text-myconfort-green" /> Ville <span className="text-red-600 font-bold">*</span>
                </label>
                <input
                  type="text"
                  value={client.city || ''}
                  ...
                  required
                />
                {!isFieldValid('city') && <p className="text-myconfort-coral text-xs">Ce champ est requis.</p>}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-0">
                <label className="flex items-center gap-1 text-base font-medium text-myconfort-dark font-manrope">
                  <Hash className="w-4 h-4 text-myconfort-green" /> Code postal <span className="text-red-600 font-bold">*</span>
                </label>
                <input
                  type="text"
                  inputMode="numeric"
                  ...
                  required
                />
                {!isFieldValid('postalCode') && <p className="text-myconfort-coral text-xs">Ce champ est requis.</p>}
              </div>

              {/* Type de logement */}
              <div className="space-y-0">
                <label className="flex items-center gap-1 text-base font-medium text-myconfort-dark font-manrope">
                  <Home className="w-4 h-4 text-myconfort-green" /> Type de logement <span className="text-red-600 font-bold">*</span>
                </label>
                <select
                ...
                {!isFieldValid('housingType') && <p className="text-myconfort-coral text-xs">Ce champ est requis.</p>}
              </div>

              {/* Code porte / Pas de digicode */}
              <div className="space-y-0">
                <label className="flex items-center gap-1 text-base font-medium text-myconfort-dark font-manrope">
                  <Key className="w-4 h-4 text-myconfort-green" /> Code porte <span className="text-red-600 font-bold">*</span>
                </label>
                ...
                {!isFieldValid('doorCode') && <p className="text-myconfort-coral text-xs">Saisir un code ou choisir "Pas de code".</p>}
              </div>
            </div>
          </form>
        </div>
