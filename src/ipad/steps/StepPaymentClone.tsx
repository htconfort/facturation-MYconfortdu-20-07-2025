// StepPaymentClone.tsx - Version stable avec StepPaiementScrollable
import { useState, useMemo, useCallback } from 'react';
import { useInvoiceWizard } from '../../store/useInvoiceWizard';
import { calculateProductTotal } from '../../utils/calculations';
import AlmaLogo from '../../assets/images/Alma_orange.png';
import NumericInput from '../../components/NumericInput';
import StepPaiementScrollable from './StepPaiementScrollable';
...
export default function StepPaymentClone({ onNext, onPrev }: StepProps) {
  ...
  return (
    ...
    >
      ...
      {/* Espace supplémentaire pour s'assurer que tout est accessible */}
