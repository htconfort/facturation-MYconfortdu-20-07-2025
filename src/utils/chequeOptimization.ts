 ...
 */
export function proposerAcomptePourChequesRonds(totalTTC: number, nbCheques: number): ChequeOptimization {
 ...
 */
export function formatMessageOptimisation(optimization: ChequeOptimization): string {
 ...
 */
export function calculerGainTemps(nbCheques: number, avecCentimes: boolean): string {
 ...
 */
export function optimisationBenefique(totalTTC: number, nbCheques: number): boolean {
