      ...
      <div className='border-2 border-dashed border-gray-300 p-4'>
        {currentStyle === 'classic' && (
          <div key='test-classic'>
            <h3 className='text-center font-bold mb-4 text-green-600'>
              STYLE CLASSIQUE
            </h3>
        ...
        {currentStyle === 'modern' && (
          <div key='test-modern'>
            <h3 className='text-center font-bold mb-4 text-blue-600'>
              STYLE MODERNE
            </h3>
        ...
        {currentStyle === 'premium' && (
          <div key='test-premium'>
            <h3 className='text-center font-bold mb-4 text-purple-600'>
              STYLE PREMIUM
            </h3>
