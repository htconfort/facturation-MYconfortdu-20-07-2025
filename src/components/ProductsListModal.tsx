...
export const ProductsListModal: React.FC<ProductsListModalProps> = ({
  ...
  const handleDeleteProduct = (index: number) => {
    ...
    if (
      window.confirm(`Êtes-vous sûr de vouloir supprimer "${product.name}" ?`)
    ) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title='' maxWidth='max-w-6xl'>
      ...
      <div
        className='space-y-6'
        style={{ backgroundColor: '#F2EFE2', color: '#000000' }}
      >
        {/* Statistiques */}
        <div
        ...
        >
          ...
          <div className='bg-white border-2 border-gray-300 p-4 rounded-lg shadow-sm'>
            ...
            <div className='text-lg font-bold mt-1 text-black'>
              {formatCurrency(
                products.reduce((sum, p) => sum + p.priceTTC, 0) /
                  products.length || 0
              )}
            </div>
          </div>
              ...
              <label className='flex items-center space-x-2'>
                <input
                  ...
                  onChange={e =>
                    setNewProduct({
                      ...newProduct,
                      autoCalculateHT: e.target.checked,
                    })
                  }
                  className='form-checkbox h-4 w-4 text-blue-600'
                />
                <span className='text-black font-semibold'>
                  Calcul automatique HT
                </span>
              </label>
          ...
          {Object.keys(productsByCategory).length === 0 ? (
            <div className='bg-white p-8 rounded-lg border-2 border-gray-300 text-center'>
              ...
              <p className='text-gray-600 mt-1'>
                Modifiez vos critères de recherche ou ajoutez un nouveau produit
              </p>
            </div>
          ) : (
                    ...
                    <table className='w-full' style={{ minWidth: '900px' }}>
                      <thead>
                        <tr className='bg-gray-50 border-b border-gray-300'>
                          ...
                          <th className='px-4 py-3 text-right font-bold text-black'>
                            Prix TTC
                          </th>
                            ...
                            >
                              ...
                              <td className='px-4 py-3'>
                                <div className='flex justify-center space-x-1'>
                                  ...
                                  <button
                                    onClick={() =>
                                      handleDeleteProduct(globalIndex)
                                    }
        ...
        <div className='bg-blue-50 border-2 border-blue-200 rounded-lg p-4'>
          <div className='flex items-start space-x-2'>
            ...
            <div className='text-sm text-blue-800'>
              ...
              <p className='mt-1'>
                • Cliquez sur un nom ou prix pour le modifier directement
                <br />
                • Les modifications sont automatiquement sauvegardées
                <br />
                • Le calcul HT automatique utilise le taux de TVA de la facture
                <br />• Les nouveaux produits seront disponibles dans le
                catalogue
              </p>
            </div>
          </div>
