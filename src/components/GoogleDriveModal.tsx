      ...
      <div className='space-y-6'>
        ...
        <div className='bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg p-4'>
          ...
          <p className='mt-2 text-sm text-blue-100'>
            Cette intégration permet d'envoyer automatiquement vos factures PDF
            vers Google Drive via n8n.
          </p>
        </div>
            ...
            <div className='flex items-center space-x-2'>
              ...
              <div>
                ...
                <p className='text-sm text-red-600'>
                  Veuillez vérifier votre connexion internet pour utiliser cette
                  fonctionnalité
                </p>
              </div>
            </div>
        ...
        <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
          ...
          <ol className='list-decimal ml-5 space-y-2 text-sm text-blue-700'>
            <li>
              Créez un workflow dans n8n avec un webhook comme déclencheur
            </li>
        ...
        <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
          ...
          <ul className='list-disc ml-5 space-y-2 text-sm text-yellow-700'>
            <li>
              <strong>Erreur "Failed to fetch"</strong> - Vérifiez que votre
              instance n8n est en ligne et accessible
            </li>
            <li>
              <strong>Erreur CORS</strong> - Configurez votre n8n pour accepter
              les requêtes de votre domaine
            </li>
            <li>
              <strong>Erreur 404</strong> - Vérifiez que l'URL du webhook est
              correcte et que le workflow est actif
            </li>
            <li>
              <strong>Timeout</strong> - Vérifiez la connectivité réseau et que
              n8n répond dans un délai raisonnable
            </li>
            <li>
              <strong>Erreur HTTPS</strong> - Assurez-vous que votre navigateur
              accepte les requêtes vers le serveur n8n
            </li>
          </ul>
        </div>
