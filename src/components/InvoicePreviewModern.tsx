...
export const InvoicePreviewModern = forwardRef<
  HTMLDivElement,
  InvoicePreviewModernProps
      ...
      >
        ...
        <div style={{ padding: '40px' }}>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <div style={{ marginTop: '2px', color: '#2D3748' }}>
                  {invoice.clientDoorCode || 'Non spécifié'}
                </div>
              </div>
              <div>
                        ...
                        >
                          <span
                            style={{
                              ...
                              padding: '4px 8px',
                              borderRadius: '12px',
                              background: product.isPickupOnSite
                                ? '#4ADE80'
                                : '#EF4444',
                              color: 'white',
                              fontWeight: 'bold',
          ...
          >
            ...
            <div
              style={{ fontSize: '14px', lineHeight: '1.6', color: '#14281D' }}
            >
              <div style={{ marginBottom: '8px' }}>
                <strong>Adresse pour règlements :</strong> SAV MYCONFORT • 8 rue
                du Grégal • 66510 Saint-Hippolyte
              </div>
                ...
                invoice.nombreChequesAVenir > 0 && (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div style={{ fontWeight: 'bold', color: '#477A0C' }}>
                          💰 Acompte versé
                        </div>
                        <div
                          style={{
                        ...
                        <div style={{ fontSize: '11px', color: '#477A0C' }}>
                          ({((acompteAmount / totalTTC) * 100).toFixed(1)}% du
                          total)
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div style={{ fontSize: '11px', color: '#477A0C' }}>
                          Réparti sur {invoice.nombreChequesAVenir} chèque
                          {invoice.nombreChequesAVenir > 1 ? 's' : ''}
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        {formatCurrency(
                          montantRestant / invoice.nombreChequesAVenir
                        )}
                      </div>
                      <div
                        style={{
