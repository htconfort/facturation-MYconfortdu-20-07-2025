  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <label className="flex flex-col gap-2">
          <span className="text-sm font-medium text-gray-700">Adresse (ligne 1) *</span>
          <input 
            className="border border-gray-300 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-[#477A0C] focus:border-transparent"
        ...
        <label className="flex flex-col gap-2">
          <span className="text-sm font-medium text-gray-700">Adresse (ligne 2)</span>
          <input 
            className="border border-gray-300 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-[#477A0C] focus:border-transparent"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <label className="flex flex-col gap-2">
            ...
            <input 
              ...
              onChange={e => setForm({ ...form, clientPostalCode: e.target.value })}
              placeholder="75000"
            />
          </label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <label className="flex flex-col gap-2">
            <span className="text-sm font-medium text-gray-700">Code porte</span>
            <input 
              className="border border-gray-300 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-[#477A0C] focus:border-transparent"
              value={form.clientDoorCode || ''}
              onChange={e => setForm({ ...form, clientDoorCode: e.target.value })}
              placeholder="A123B"
            />
          </label>

          <label className="flex flex-col gap-2">
            <span className="text-sm font-medium text-gray-700">Type logement</span>
            <select 
              className="border border-gray-300 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-[#477A0C] focus:border-transparent"
              value={form.clientHousingType || ''}
              onChange={e => setForm({ ...form, clientHousingType: e.target.value })}
            >
        ...
        <label className="flex flex-col gap-2">
          <span className="text-sm font-medium text-gray-700">SIRET (professionnel)</span>
          <input 
            className="border border-gray-300 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-[#477A0C] focus:border-transparent"
        ...
        <div className="text-xs text-gray-500 mt-4 p-3 bg-gray-50 rounded-lg">
          <span className="font-medium">💡 Astuce iPad :</span> Les champs marqués d'un * sont obligatoires. 
          Touchez "Enregistrer" pour sauvegarder et revenir à la facture.
        </div>
      </div>
    </WizardSheet>
  );
