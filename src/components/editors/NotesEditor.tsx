...
• Points à retenir pour la prochaine fois'
          />
          <div className='text-xs text-gray-500'>
            {(form.internalNotes || '').length} caractères • Usage interne
            uniquement
          </div>
        </label>
        ...
        <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
          ...
          <div className='space-y-2 text-sm text-blue-700'>
            ...
            >
              <strong>Garantie standard</strong>
              <br />
            ...
            <button
              onClick={() =>
                setForm({
                  ...form,
                  notes:
                    'Intervention réalisée selon les normes en vigueur.\nClient satisfait de la prestation.\nAucun problème particulier signalé.',
                })
              }
              className='block w-full text-left p-2 bg-white rounded hover:bg-blue-50 transition-colors'
            >
              <strong>Intervention standard</strong>
              <br />
        ...
        <div className='text-xs text-gray-500 p-3 bg-gray-50 rounded-lg'>
          <span className='font-medium'>📱 Aide iPad :</span> Les zones de texte
          s'agrandissent automatiquement. Utilisez les modèles ci-dessus pour
          gagner du temps. Les notes publiques apparaîtront sur la facture
          client.
        </div>
      </div>
    </WizardSheet>
