...
export const DeliveryStatusSummary: React.FC<DeliveryStatusSummaryProps> = ({
  products,
}) => {
  ...
  const deliveredPercent =
    totalProducts > 0 ? Math.round((deliveredCount / totalProducts) * 100) : 0;
  const progressPercent =
    totalProducts > 0
      ? Math.round(((deliveredCount + cancelledCount) / totalProducts) * 100)
      : 0;
