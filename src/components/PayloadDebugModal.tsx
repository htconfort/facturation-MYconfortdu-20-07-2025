      ...
      <div className='space-y-6'>
          ...
          <div className='flex items-center space-x-3 mb-2'>
            ...
            <div>
              ...
              <p className='text-orange-100'>
                Validation et test du payload avant envoi
              </p>
            </div>
          </div>
        </div>
                ...
                <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
                  <div>
                    ...
                    <div className='text-blue-800'>
                      {JSON.stringify(debugData.validation.payload).length}{' '}
                      caractères
                    </div>
                  </div>
                  <div>
                    ...
                    <div className='text-blue-800'>
                      {debugData.validation.payload.products?.length || 0}
                    </div>
                  </div>
                  <div>
                    <span className='text-blue-600 font-semibold'>
                    ...
                    <div className='text-blue-800'>
                      {debugData.validation.payload.pdfSizeKB} KB
                    </div>
                  </div>
                  <div>
                    <span className='text-blue-600 font-semibold'>
                    ...
                    <div className='text-blue-800'>
                      {debugData.validation.payload.signature ? 'Oui' : 'Non'}
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
          ...
          <ol className='list-decimal ml-5 space-y-2 text-sm text-yellow-700'>
            <li>
              Cliquez sur "Générer Payload Debug" pour valider la structure
            </li>
            ...
            <li>
              Dans n8n, activez "Listen for test event" pour voir les données
              reçues
            </li>
          </ol>
        </div>
