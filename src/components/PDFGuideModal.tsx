...
export const PDFGuideModal: React.FC<PDFGuideModalProps> = ({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Génération de PDF - Guide d'utilisation"
      maxWidth='max-w-2xl'
    >
      <div className='space-y-6'>
          ...
          <div className='flex items-center space-x-3 mb-2'>
            ...
            <div>
              ...
              <p className='text-green-100'>
                Créez et partagez vos factures facilement
              </p>
            </div>
          </div>

          <p className='mt-2 text-sm text-green-100'>
            Ce guide vous explique comment générer et partager vos factures au
            format PDF.
          </p>
        </div>
        ...
        <div className='bg-white border border-gray-200 rounded-lg p-4'>
          ...
          <ol className='list-decimal ml-5 space-y-2 text-gray-700'>
            <li>
              Remplissez toutes les informations de la facture (client,
              produits, etc.)
            </li>
            <li>
              Cliquez sur le bouton{' '}
              <strong>"Générer et télécharger le PDF"</strong> dans la section
              principale
            </li>
            <li>Le PDF sera automatiquement téléchargé sur votre appareil</li>
            <li>
              Pour prévisualiser avant de télécharger, utilisez le bouton{' '}
        ...
        <div className='bg-purple-50 border border-purple-200 rounded-lg p-4'>
          <h4 className='font-medium text-purple-800 mb-3'>
            Comment partager votre facture :
          </h4>

          <ol className='list-decimal ml-5 space-y-2 text-purple-700'>
            <li>
              Cliquez sur <strong>"APERÇU & PDF"</strong> pour ouvrir la
              prévisualisation
            </li>
            <li>
              Dans la fenêtre de prévisualisation, utilisez le bouton{' '}
              <strong>"Partager Aperçu"</strong>
            </li>
            <li>
              Vous pouvez également envoyer le PDF téléchargé par email
              manuellement
            </li>
          </ol>
        </div>
        ...
        <div className='flex justify-between items-center pt-4 border-t'>
          ...
          <button
            onClick={() => {
              onSuccess(
                '✅ Guide consulté avec succès ! Vous pouvez maintenant générer vos PDF.'
              );
              onClose();
            }}
