...
function App() {
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      showToast(
        `PDF téléchargé: facture-${invoice.invoiceNumber}.pdf`,
        'success'
      );
    } catch (error) {
      ...
      <div className='max-w-4xl mx-auto'>
            ...
            <div className='text-center py-8'>
              ...
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4'>
                ...
                <p className='text-blue-700 text-sm mt-1'>
                  Cliquez sur le bouton ci-dessous pour voir la facture au
                  format A4 professionnel avec signature électronique et
                  conditions générales. Ce sera le MÊME format que pour
        ...
        <div className='bg-white rounded-lg shadow-md p-6'>
          ...
          <ul className='space-y-2 text-gray-700'>
            <li>
              • <strong>Aperçu unique :</strong> PDFPreviewModal comme référence
              unique
            </li>
            <li>
              • <strong>Format A4 :</strong> Facture professionnelle avec
              pagination
            </li>
            <li>
              • <strong>Signature :</strong> Zone signature électronique 2x3cm
            </li>
            <li>
              • <strong>CGV :</strong> Conditions générales en page 2
            </li>
            <li>
              • <strong>Impression :</strong> CSS optimisé pour impression sans
              interface
            </li>
            <li>
              • <strong>Export PDF :</strong> Même rendu que l'aperçu et
              l'impression
            </li>
          </ul>
        </div>
